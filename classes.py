...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if execedeu_saldo:
            print(f"Operação não realizada: Saldo insuficiente. Saldo atual: R${self._saldo}")
        elif valor > 0:
            self._saldo -= valor
            print(f"Saque no valor de R${valor} realizado com sucesso. Saldo atual: R${self._saldo}")
            return True
        else:
    ...
    def depositar(self, valor):
        if valor > 0:
            self._saldo += valor
            print(f"Depósito no valor de R${valor} realizado com sucesso. Saldo atual: R${self._saldo}")
